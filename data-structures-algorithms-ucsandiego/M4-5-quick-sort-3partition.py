...
def quick_sort3p_2nd(arr, lower, upper):
    """
    This second attemp version moves the pivot up as it finds new elements lesser than the pivot. The code is cleaner, but slightly more calls are necessary.
    """
    # global no_calls2
    # no_calls2 += 1
    if lower>=upper:
